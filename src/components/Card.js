...
export default function Card(props) {
  ...
  const subContextCard = React.useContext(Context)
  const isOwn = props.card.owner._id === subContextCard._id;
  const isLiked = props.card.likes.some(card => card._id === subContextCard._id);
